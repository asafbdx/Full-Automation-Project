...
from page_objects.web_objects.admin_new_user_page import NewUsersPage
from page_objects.web_objects.administration_menu_page import AdministrationMenuPage
from page_objects.web_objects.lef_menu_page import LeftMenuPage
...
class ManagePages:
    ...
    def init_web_pages():
        ...
        globals()["web_admin_menu"] = AdministrationMenuPage(conf.driver)
        globals()["web_users_page"] = UsersPage(conf.driver)
        globals()["web_admin_new_user"] = NewUsersPage(conf.driver)
